			...
			<div className='contentContainer'>
				<div className="textContainer">
					<div className='decoIconWrapper'>
						<img className='decoIcon' src={BrowserIcon} alt='browser icon'/>
					</div>
				...
				<div className="textContainer">
					<div className='decoIconWrapper'>
						<img className='decoIcon' src={LinkIcon} alt='link icon'/>
					</div>
				...
				<div className="textContainer">
					<div className='decoIconWrapper'>
						<img className='decoIcon' src={LayersIcon} alt='layers icon'/>
					</div>
				...
				<div className="textContainer">
					<div className='decoIconWrapper'>
						<img className='decoIcon' src={BrushIcon} alt='brush icon'/>
					</div>
